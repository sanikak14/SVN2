...
/*     */ 
/*     */     
/* 118 */     desc = new XMLFieldDescriptorImpl(SupplierProductDetail.class, "_supplierProductDetail", "SupplierProductDetail", NodeType.Element);
/* 119 */     xMLFieldHandler = new XMLFieldHandler()
/*     */       {
/*     */         public Object getValue(Object object) throws IllegalStateException
/*     */         {
/* 123 */           ProductResponse target = (ProductResponse)object;
/* 124 */           return target.getSupplierProductDetail();
/*     */         }
/*     */ 
/*     */         
/*     */         public void setValue(Object object, Object value) throws IllegalStateException, IllegalArgumentException {
...
/* 131 */             target.setSupplierProductDetail((SupplierProductDetail)value);
/* 132 */           } catch (Exception ex) {
/* 133 */             throw new IllegalStateException(ex.toString());
/*     */           } 
/*     */         }
/*     */         public Object newInstance(Object parent) {
/* 137 */           return new SupplierProductDetail();
/*     */         }
/*     */       };
/* 140 */     desc.setSchemaType("com.metcash.webservices.eai.xml.supplier.pricesoh.validation.SupplierProductDetail");
...
/*     */         }
/*     */       };
/* 175 */     desc.setSchemaType("com.metcash.webservices.eai.xml.supplier.pricesoh.validation.Message");
/* 176 */     desc.setHandler((FieldHandler)xMLFieldHandler);
/* 177 */     desc.setNameSpaceURI("metcash/supplierPriceSohResponse");
...
/* Location:              D:\Sanika\iOrders War file\Production backu\cf portalapp04\almws.war\WEB-INF\classes\!\com\metcash\webservices\eai\xml\supplier\pricesoh\validation\descriptors\ProductResponseDescriptor.class
