...
/*     */ 
/*     */ 
/*     */ public class OrderResponseDescriptor
...
/*     */   
/*     */   public OrderResponseDescriptor() {
/*  60 */     this._nsURI = "metcash/orderStatusResponse";
/*  61 */     this._xmlName = "OrderResponse";
...
/*     */         {
/*  77 */           OrderResponse target = (OrderResponse)object;
...
/*     */           try {
/*  85 */             OrderResponse target = (OrderResponse)object;
/*     */             
/*  87 */             if (value == null)
/*     */               return; 
...
/*     */ 
/*     */     
/* 118 */     desc = new XMLFieldDescriptorImpl(OrderStatusDetail.class, "_orderStatusDetail", "OrderStatusDetail", NodeType.Element);
/* 119 */     xMLFieldHandler = new XMLFieldHandler()
/*     */       {
/*     */         public Object getValue(Object object) throws IllegalStateException
/*     */         {
/* 123 */           OrderResponse target = (OrderResponse)object;
/* 124 */           return target.getOrderStatusDetail();
/*     */         }
/*     */ 
/*     */         
/*     */         public void setValue(Object object, Object value) throws IllegalStateException, IllegalArgumentException {
/*     */           try {
/* 130 */             OrderResponse target = (OrderResponse)object;
/* 131 */             target.setOrderStatusDetail((OrderStatusDetail)value);
/* 132 */           } catch (Exception ex) {
/* 133 */             throw new IllegalStateException(ex.toString());
/*     */           } 
/*     */         }
/*     */         public Object newInstance(Object parent) {
/* 137 */           return new OrderStatusDetail();
/*     */         }
/*     */       };
/* 140 */     desc.setSchemaType("com.metcash.webservices.eai.xml.supplier.orderstatus.validation.OrderStatusDetail");
...
/*     */         public Object getValue(Object object) throws IllegalStateException
/*     */         {
/* 158 */           OrderResponse target = (OrderResponse)object;
...
/*     */         public void setValue(Object object, Object value) throws IllegalStateException, IllegalArgumentException {
/*     */           try {
/* 165 */             OrderResponse target = (OrderResponse)object;
...
/*     */         }
/*     */       };
/* 175 */     desc.setSchemaType("com.metcash.webservices.eai.xml.supplier.orderstatus.validation.Message");
/* 176 */     desc.setHandler((FieldHandler)xMLFieldHandler);
/* 177 */     desc.setNameSpaceURI("metcash/orderStatusResponse");
...
/* 222 */     return OrderResponse.class;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Sanika\iOrders War file\Production backu\cf portalapp04\almws.war\WEB-INF\classes\!\com\metcash\webservices\eai\xml\supplier\orderstatus\validation\descriptors\OrderResponseDescriptor.class
