...
/*  36 */   public static final BackOrderType Y = new BackOrderType(0, "Y");
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*  46 */   public static final BackOrderType N = new BackOrderType(1, "N");
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*     */   private BackOrderType(int type, String value) {
/*  70 */     this.type = type;
...
/*     */ 
/*     */   
/*     */   public static BackOrderType valueOf(String string) {
/* 146 */     Object obj = null;
/* 147 */     if (string != null) {
/* 148 */       obj = _memberTable.get(string);
/*     */     }
/* 150 */     if (obj == null) {
/* 151 */       String err = string + " is not a valid BackOrderType";
/* 152 */       throw new IllegalArgumentException(err);
/*     */     } 
/* 154 */     return (BackOrderType)obj;
/*     */   }
/*     */ }


/* Location:              D:\Sanika\iOrders War file\Production backu\cf portalapp04\almws.war\WEB-INF\classes\!\com\metcash\webservices\eai\xml\retailer\order\types\BackOrderType.class
