...
public class MessageTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public MessageTypeDescriptor() {
        ...
        //-- _severity
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.metcash.webservices.eai.xml.globaltypes.types.SeverityType.class, "_severity", "severity", org.exolab.castor.xml.NodeType.Attribute);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    MessageType target = (MessageType) object;
                    target.setSeverity( (com.metcash.webservices.eai.xml.globaltypes.types.SeverityType) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        handler = new org.exolab.castor.xml.handlers.EnumFieldHandler(com.metcash.webservices.eai.xml.globaltypes.types.SeverityType.class, handler);
        desc.setImmutable(true);
        desc.setSchemaType("SeverityType");
        desc.setHandler(handler);
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
    ...
    public java.lang.Class getJavaClass(
        ...
        return com.metcash.webservices.eai.xml.globaltypes.MessageType.class;
    }
