...
public class ProductResponseDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ProductResponseDescriptor() {
        ...
        //-- _supplierProductDetail
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.metcash.webservices.eai.xml.supplier.pricesoh.validation.SupplierProductDetail.class, "_supplierProductDetail", "SupplierProductDetail", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ProductResponse target = (ProductResponse) object;
                return target.getSupplierProductDetail();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ProductResponse target = (ProductResponse) object;
                    target.setSupplierProductDetail( (com.metcash.webservices.eai.xml.supplier.pricesoh.validation.SupplierProductDetail) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.metcash.webservices.eai.xml.supplier.pricesoh.validation.SupplierProductDetail();
            }
        };
        desc.setSchemaType("com.metcash.webservices.eai.xml.supplier.pricesoh.validation.SupplierProductDetail");
        desc.setHandler(handler);
        ...
        //-- validation code for: _supplierProductDetail
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return com.metcash.webservices.eai.xml.supplier.pricesoh.validation.ProductResponse.class;
    }
