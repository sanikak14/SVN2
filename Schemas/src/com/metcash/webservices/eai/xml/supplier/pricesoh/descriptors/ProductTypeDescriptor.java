...
public class ProductTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ProductTypeDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _codeType
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.metcash.webservices.eai.xml.globaltypes.types.ProductCodeTypeType.class, "_codeType", "codeType", org.exolab.castor.xml.NodeType.Attribute);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ProductType target = (ProductType) object;
                return target.getCodeType();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ProductType target = (ProductType) object;
                    target.setCodeType( (com.metcash.webservices.eai.xml.globaltypes.types.ProductCodeTypeType) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        handler = new org.exolab.castor.xml.handlers.EnumFieldHandler(com.metcash.webservices.eai.xml.globaltypes.types.ProductCodeTypeType.class, handler);
        desc.setImmutable(true);
        desc.setSchemaType("com.metcash.webservices.eai.xml.globaltypes.types.ProductCodeTypeType");
        desc.setHandler(handler);
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        
        //-- validation code for: _codeType
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
    ...
    public java.lang.Class getJavaClass(
        ...
        return com.metcash.webservices.eai.xml.supplier.pricesoh.ProductType.class;
    }
