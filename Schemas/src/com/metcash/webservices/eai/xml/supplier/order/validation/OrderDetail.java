...
public class OrderDetail implements java.io.Serializable {
     ...
     */
    private com.metcash.webservices.eai.xml.supplier.order.validation.OrderHeaderResponse _orderHeaderResponse;
    ...
    public void addLineMessages(
            final com.metcash.webservices.eai.xml.supplier.order.validation.LineMessages vLineMessages)
     ...
     * at the given index
     */
    public com.metcash.webservices.eai.xml.supplier.order.validation.LineMessages getLineMessages(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.metcash.webservices.eai.xml.supplier.order.validation.LineMessages) _lineMessagesList.get(index);
    }
    ...
    public com.metcash.webservices.eai.xml.supplier.order.validation.LineMessages[] getLineMessages(
        ...
        com.metcash.webservices.eai.xml.supplier.order.validation.LineMessages[] array = new com.metcash.webservices.eai.xml.supplier.order.validation.LineMessages[0];
        return (com.metcash.webservices.eai.xml.supplier.order.validation.LineMessages[]) this._lineMessagesList.toArray(array);
    }
     ...
     */
    public com.metcash.webservices.eai.xml.supplier.order.validation.OrderHeaderResponse getOrderHeaderResponse(
    ) {
     ...
     */
    public com.metcash.webservices.eai.xml.supplier.order.validation.LineMessages removeLineMessagesAt(
            final int index) {
        java.lang.Object obj = this._lineMessagesList.remove(index);
        return (com.metcash.webservices.eai.xml.supplier.order.validation.LineMessages) obj;
    }
     ...
     */
    public void setLineMessages(
            final com.metcash.webservices.eai.xml.supplier.order.validation.LineMessages[] vLineMessagesArray) {
        //-- copy array
    ...
    public void setOrderHeaderResponse(
            final com.metcash.webservices.eai.xml.supplier.order.validation.OrderHeaderResponse orderHeaderResponse) {
     ...
     * com.metcash.webservices.eai.xml.supplier.order.validation.OrderDetail
     */
    public static com.metcash.webservices.eai.xml.supplier.order.validation.OrderDetail unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.metcash.webservices.eai.xml.supplier.order.validation.OrderDetail) Unmarshaller.unmarshal(com.metcash.webservices.eai.xml.supplier.order.validation.OrderDetail.class, reader);
    }
