 ...
 */
public class SupplierOrderResponse implements java.io.Serializable {
    ...
    public void addOrderDetail(
            final com.metcash.webservices.eai.xml.supplier.order.validation.OrderDetail vOrderDetail)
     ...
     * at the given index
     */
    public com.metcash.webservices.eai.xml.supplier.order.validation.OrderDetail getOrderDetail(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.metcash.webservices.eai.xml.supplier.order.validation.OrderDetail) _orderDetailList.get(index);
    }
    ...
    public com.metcash.webservices.eai.xml.supplier.order.validation.OrderDetail[] getOrderDetail(
        ...
        com.metcash.webservices.eai.xml.supplier.order.validation.OrderDetail[] array = new com.metcash.webservices.eai.xml.supplier.order.validation.OrderDetail[0];
        return (com.metcash.webservices.eai.xml.supplier.order.validation.OrderDetail[]) this._orderDetailList.toArray(array);
    }
     ...
     */
    public com.metcash.webservices.eai.xml.supplier.order.validation.OrderDetail removeOrderDetailAt(
            final int index) {
        java.lang.Object obj = this._orderDetailList.remove(index);
        return (com.metcash.webservices.eai.xml.supplier.order.validation.OrderDetail) obj;
    }
     ...
     */
    public void setOrderDetail(
            final com.metcash.webservices.eai.xml.supplier.order.validation.OrderDetail[] vOrderDetailArray) {
        //-- copy array
     ...
     * com.metcash.webservices.eai.xml.supplier.order.validation.SupplierOrderResponse
     */
    public static com.metcash.webservices.eai.xml.supplier.order.validation.SupplierOrderResponse unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.metcash.webservices.eai.xml.supplier.order.validation.SupplierOrderResponse) Unmarshaller.unmarshal(com.metcash.webservices.eai.xml.supplier.order.validation.SupplierOrderResponse.class, reader);
    }
