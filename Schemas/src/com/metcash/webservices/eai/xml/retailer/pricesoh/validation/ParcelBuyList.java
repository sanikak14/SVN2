...
public class ParcelBuyList implements java.io.Serializable {
    ...
    public void addParcelBuy(
            final com.metcash.webservices.eai.xml.retailer.pricesoh.validation.ParcelBuy vParcelBuy)
     ...
     * com.metcash.webservices.eai.xml.retailer.pricesoh.validation.ParcelBuy
     * at the given index
     */
    public com.metcash.webservices.eai.xml.retailer.pricesoh.validation.ParcelBuy getParcelBuy(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.metcash.webservices.eai.xml.retailer.pricesoh.validation.ParcelBuy) _parcelBuyList.get(index);
    }
    ...
    public com.metcash.webservices.eai.xml.retailer.pricesoh.validation.ParcelBuy[] getParcelBuy(
        ...
        com.metcash.webservices.eai.xml.retailer.pricesoh.validation.ParcelBuy[] array = new com.metcash.webservices.eai.xml.retailer.pricesoh.validation.ParcelBuy[0];
        return (com.metcash.webservices.eai.xml.retailer.pricesoh.validation.ParcelBuy[]) this._parcelBuyList.toArray(array);
    }
     ...
     */
    public com.metcash.webservices.eai.xml.retailer.pricesoh.validation.ParcelBuy removeParcelBuyAt(
            final int index) {
        java.lang.Object obj = this._parcelBuyList.remove(index);
        return (com.metcash.webservices.eai.xml.retailer.pricesoh.validation.ParcelBuy) obj;
    }
     ...
     */
    public void setParcelBuy(
            final com.metcash.webservices.eai.xml.retailer.pricesoh.validation.ParcelBuy[] vParcelBuyArray) {
        //-- copy array
     ...
     * com.metcash.webservices.eai.xml.retailer.pricesoh.validation.ParcelBuyList
     */
    public static com.metcash.webservices.eai.xml.retailer.pricesoh.validation.ParcelBuyList unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.metcash.webservices.eai.xml.retailer.pricesoh.validation.ParcelBuyList) Unmarshaller.unmarshal(com.metcash.webservices.eai.xml.retailer.pricesoh.validation.ParcelBuyList.class, reader);
    }
