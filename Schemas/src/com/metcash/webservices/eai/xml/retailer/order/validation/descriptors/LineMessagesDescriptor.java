...
/**
 * Class LineMessagesDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class LineMessagesDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public LineMessagesDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                LineMessages target = (LineMessages) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _lineMessageData
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_lineMessageData", "LineMessageData", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                LineMessages target = (LineMessages) object;
                return target.getLineMessageData();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    LineMessages target = (LineMessages) object;
                    target.setLineMessageData( (java.lang.String) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        //-- validation code for: _lineMessageData
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
            org.exolab.castor.xml.validators.StringValidator typeValidator;
            typeValidator = new org.exolab.castor.xml.validators.StringValidator();
        ...
        desc.setValidator(fieldValidator);
        //-- _lineMessageSeverity
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_lineMessageSeverity", "LineMessageSeverity", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                LineMessages target = (LineMessages) object;
                return target.getLineMessageSeverity();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    LineMessages target = (LineMessages) object;
                    target.setLineMessageSeverity( (java.lang.String) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        //-- validation code for: _lineMessageSeverity
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
            org.exolab.castor.xml.validators.StringValidator typeValidator;
            typeValidator = new org.exolab.castor.xml.validators.StringValidator();
    ...
    public java.lang.Class getJavaClass(
        ...
        return com.metcash.webservices.eai.xml.retailer.order.validation.LineMessages.class;
    }
