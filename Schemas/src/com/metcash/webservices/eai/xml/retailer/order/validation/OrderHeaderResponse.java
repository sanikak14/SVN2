...
public class OrderHeaderResponse implements java.io.Serializable {
     ...
     */
    private com.metcash.webservices.eai.xml.retailer.order.validation.types.CustomerStateCodeType _customerStateCode;
    ...
    public void addOrderHeaderMessages(
            final com.metcash.webservices.eai.xml.retailer.order.validation.OrderHeaderMessages vOrderHeaderMessages)
     ...
     */
    public com.metcash.webservices.eai.xml.retailer.order.validation.types.CustomerStateCodeType getCustomerStateCode(
    ) {
     ...
     * at the given index
     */
    public com.metcash.webservices.eai.xml.retailer.order.validation.OrderHeaderMessages getOrderHeaderMessages(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.metcash.webservices.eai.xml.retailer.order.validation.OrderHeaderMessages) _orderHeaderMessagesList.get(index);
    }
    ...
    public com.metcash.webservices.eai.xml.retailer.order.validation.OrderHeaderMessages[] getOrderHeaderMessages(
        ...
        com.metcash.webservices.eai.xml.retailer.order.validation.OrderHeaderMessages[] array = new com.metcash.webservices.eai.xml.retailer.order.validation.OrderHeaderMessages[0];
        return (com.metcash.webservices.eai.xml.retailer.order.validation.OrderHeaderMessages[]) this._orderHeaderMessagesList.toArray(array);
    }
     ...
     */
    public com.metcash.webservices.eai.xml.retailer.order.validation.OrderHeaderMessages removeOrderHeaderMessagesAt(
            final int index) {
        java.lang.Object obj = this._orderHeaderMessagesList.remove(index);
        return (com.metcash.webservices.eai.xml.retailer.order.validation.OrderHeaderMessages) obj;
    }
    ...
    public void setCustomerStateCode(
            final com.metcash.webservices.eai.xml.retailer.order.validation.types.CustomerStateCodeType customerStateCode) {
     ...
     */
    public void setOrderHeaderMessages(
            final com.metcash.webservices.eai.xml.retailer.order.validation.OrderHeaderMessages[] vOrderHeaderMessagesArray) {
        //-- copy array
     ...
     * com.metcash.webservices.eai.xml.retailer.order.validation.OrderHeaderResponse
     */
    public static com.metcash.webservices.eai.xml.retailer.order.validation.OrderHeaderResponse unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.metcash.webservices.eai.xml.retailer.order.validation.OrderHeaderResponse) Unmarshaller.unmarshal(com.metcash.webservices.eai.xml.retailer.order.validation.OrderHeaderResponse.class, reader);
    }
